			...
			<div class="panel-header">
				...
				<div class="main-form">
					<form action="index.php" method="POST">
			            ...
			            <input type="text" required placeholder="BOOK ID">
			            <input type="text" required placeholder="11/03/2017">
			            <input type="text" required placeholder="FOR HOW MANY DAYS">
			            <input type="tel" required placeholder="PHONE NUMBER">
			            <input type="submit" id="sub" value="GIVE">
			         </form>
				</div>
