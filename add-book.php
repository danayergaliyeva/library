			...
			<div class="panel-header">
				...
				<div class="main-form">
					<form action="index.php" method="POST">
			            <input type="text" required placeholder="BOOK CODE">
			            <input type="text" required placeholder="NAME">
			            <input type="text" required placeholder="PUBLISHER">
			            <input type="text" required placeholder="YEAR">
			            <input type="text" required placeholder="NUBER OF PAGES">
			            <input type="tel" required placeholder="LANGUAGES">
